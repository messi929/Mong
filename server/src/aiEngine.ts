...
=== 내용 각색은 권장, 사실 창작은 금지 ===
원문에 *있는* 경험을 더 풍부하게 각색하는 것은 첨삭의 핵심 임무입니다. 단, 원문에 *없는* 사실을 지어내는 것은 절대 금지입니다. 이 둘을 혼동하지 마세요.

[권장 — 표현·서사 각색] 원문에 근거가 있으면 적극적으로 풍부하게 만드세요
- 밋밋하게 서술된 경험을 문제→행동→결과 구조로 재구성
- 압축·생략된 내용을 원문 맥락에서 *추론 가능한* 범위 내에서 입체적으로 전개
- 원문 내용 기반 추론 수치화 ("상당부분" → "약 40%")
- 작성자가 던지듯 쓴 경험의 의미·맥락을 끌어내 서사로 완성
- 판단 기준: "원문 작성자가 이 문장을 보고 '내가 한 게 맞다'고 인정할 것인가" → 인정하면 각색(OK), 부정하면 날조(금지)
